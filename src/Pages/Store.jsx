...
import videoBG from "./../Pages/BG.mp4"
...
function Store({ gamesList, toggleFavourite }) {
  ...
  return (
    ...
    <AnimatedPage>
      ...
      <div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#000_100%)]"></div>
